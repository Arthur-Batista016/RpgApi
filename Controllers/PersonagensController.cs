    ...
    public class PersonagensController : ControllerBase
    {
            ...
            try
            {
                ...
                Personagem p = await _context.TB_PERSONAGENS
                    ...
                    .Include(ph => ph.PersonagemHabilidades)
                        .ThenInclude(h => h.Habilidade).Include(u=>u.Usuario) //Exercicio 4 - Finalizado
       ...
       public async Task<IActionResult> RestaurarPontosVidaAsync(Personagem p){
        try{
            ...
            await _context.TB_PERSONAGENS.FirstOrDefaultAsync(pBusca=> pBusca.Id == pBusca.Id);
       ...
       public async Task<IActionResult> AtualizarFotoAsync(Personagem p){
        try{
            ...
            attach.Property(x=>x.FotoPersonagem).IsModified = false;
            int linhasAfetadas = await _context.SaveChangesAsync();
            return Ok(linhasAfetadas);
